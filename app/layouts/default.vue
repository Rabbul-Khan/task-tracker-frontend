  ...
  <div class="flex flex-col min-h-screen bg-white">
    ...
    <header class="h-16 border-b border-gray-200 bg-white px-6 flex items-center justify-between sticky top-0 z-10">
      ...
      <div class="flex items-center gap-4">
        ...
        <!-- Logout Button -->
        <button class="p-2 rounded-lg hover:bg-gray-100 transition-colors" title="Logout" @click="logout">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" class="text-gray-600"><path fill="currentColor" d="M5 21q-.825 0-1.412-.587T3 19V5q0-.825.588-1.412T5 3h7v2H5v14h7v2zm11-4l-1.375-1.45l2.55-2.55H9v-2h8.175l-2.55-2.55L16 7l5 5z" /></svg>
        </button>
      </div>
    </header>
    <slot />
