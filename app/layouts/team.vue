...
const sidebarItems = [
  ...
  { key: 'all-tasks', label: 'All Tasks', icon: 'i-heroicons-clipboard-document-list' },
  ...
  <div class="flex flex-col min-h-screen bg-white">
    ...
    <div class="flex flex-1">
      ...
      <aside class="w-[250px] bg-white p-5 border-r border-gray-200 flex flex-col">
        ...
        <NuxtLink
          to="/teams"
          class="flex items-center gap-2 text-sm text-gray-500 hover:text-gray-700 mb-4 no-underline transition-colors"
        >
        ...
        <nav class="flex flex-col gap-1 flex-1">
          <button
            ...
            :key="item.key"
            class="flex items-center gap-3 px-4 py-3 text-gray-500 no-underline rounded-lg transition-all duration-200 text-[15px] hover:bg-gray-100 hover:text-gray-700 w-full text-left"
            :class="activeSection === item.key ? 'bg-primary! text-white!' : ''"
